        ...
        <Head>
          ...
          <main className="main">
            <div className="main_content">
              <div className="main_code"></div>
              <div className="main_list">
                <div className="flex_one" style={{backgroundColor:'blue'}}></div>
                <div className="flex_one"></div>
              </div>
            </div>
            <div className="center_flex txt_popular">MOST POPULAR</div>
            <div className="list_popular">
              <div style={{width:'25%',height:200,padding:'0.9804%'}}>
